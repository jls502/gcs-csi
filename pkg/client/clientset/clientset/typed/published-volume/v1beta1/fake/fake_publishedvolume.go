...
// FakePublishedVolumes implements PublishedVolumeInterface
type FakePublishedVolumes struct {
	Fake *FakeGcsV1beta1
}
...
func (c *FakePublishedVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PublishedVolume, err error) {
	...
	return obj.(*v1beta1.PublishedVolume), err
}
...
func (c *FakePublishedVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PublishedVolumeList, err error) {
	...
	list := &v1beta1.PublishedVolumeList{ListMeta: obj.(*v1beta1.PublishedVolumeList).ListMeta}
	for _, item := range obj.(*v1beta1.PublishedVolumeList).Items {
