...
type Interface interface {
	...
	GcsV1beta1() gcsv1beta1.GcsV1beta1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	gcsV1beta1 *gcsv1beta1.GcsV1beta1Client
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.gcsV1beta1, err = gcsv1beta1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.gcsV1beta1 = gcsv1beta1.New(c)
