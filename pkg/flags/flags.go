...
const (
	...
	ANNOTATION_PREFIX = "gcs.csi.shein.dev/"

	ANNOTATION_BUCKET              = "gcs.csi.shein.dev/bucket"
	ANNOTATION_PROJECT_ID          = "gcs.csi.shein.dev/project-id"
	ANNOTATION_KMS_KEY_ID          = "gcs.csi.shein.dev/kms-key-id"
	ANNOTATION_LOCATION            = "gcs.csi.shein.dev/location"
	ANNOTATION_FUSE_MOUNT_OPTION   = "gcs.csi.shein.dev/fuse-mount-options"
	ANNOTATION_DIR_MODE            = "gcs.csi.shein.dev/dir-mode"
	ANNOTATION_FILE_MODE           = "gcs.csi.shein.dev/file-mode"
	ANNOTATION_UID                 = "gcs.csi.shein.dev/uid"
	ANNOTATION_GID                 = "gcs.csi.shein.dev/gid"
	ANNOTATION_IMPLICIT_DIRS       = "gcs.csi.shein.dev/implicit-dirs"
	ANNOTATION_BILLING_PROJECT     = "gcs.csi.shein.dev/billing-project"
	ANNOTATION_LIMIT_BYTES_PER_SEC = "gcs.csi.shein.dev/limit-bytes-per-sec"
	ANNOTATION_LIMIT_OPS_PER_SEC   = "gcs.csi.shein.dev/limit-ops-per-sec"
	ANNOTATION_STAT_CACHE_TTL      = "gcs.csi.shein.dev/stat-cache-ttl"
	ANNOTATION_TYPE_CACHE_TTL      = "gcs.csi.shein.dev/type-cache-ttl"
	ANNOTATION_MAX_RETRY_SLEEP     = "gcs.csi.shein.dev/max-retry-sleep"
	...
	MOUNT_OPTION_CACHE_DIR           = "cache-dir"
	...
	MOUNT_OPTION_STAT_CACHE_TTL      = "stat-cache-max-size-mb"
	MOUNT_OPTION_TYPE_CACHE_TTL      = "type-cache-max-size-mb"
